...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    sl<ProductStore>().activeServiceScan();
    String path = "assets/images/";
    // Inicializa os projetos com os seguintes parâmetros: Path da imagem do icone, Texto e tela que representa a função
    listProjestos.add(new Projeto(path + "barcode.png", "Código de Barras",
        widget: LeituraCodigo()));

    listProjestos.add(new Projeto(path + "sensor.png", "Sensor de Presença",
        widget: SensorPage()));

    listProjestos.add(new Projeto(path + "kiosk.png", "Modo Quiosque",
        widget: QuiosquePage()));
    listProjestos.add(new Projeto(path + "tef.png", "TEF", widget: PageTef()));
    listProjestos
        .add(new Projeto(path + "icon_sat.png", "SAT", widget: PageSat()));
  }
