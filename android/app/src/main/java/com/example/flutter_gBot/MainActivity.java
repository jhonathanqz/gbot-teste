...
public class MainActivity extends FlutterActivity implements ServiceResultReceiver.Receiver {
    ...
    public static MethodChannel.Result _resultBarCode;
    
    public MethodChannel methodChannelScan; // Instanciando uma variavel do tipo Result, para enviar o resultado para o flutter
